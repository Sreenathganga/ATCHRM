...
namespace ATCHRM.Attendance
{
    public partial class MasterOTRuler : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
           ...
           // dt = dt.Select("EMPID=2320 ").CopyToDataTable();
...
# region UOTPRESENT
        ...
        public DataTable  OtRuleAction()
        {
            ...
            {
                int otvalue=0, lhvalue = 0,offotvalue=0;
                ...
                ottrans.Final_databank(empid, otvalue, extravalue, offotvalue, lhvalue, 0, adjstid );
            }
