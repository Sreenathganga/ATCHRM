...
public class RoundedGroupBox : UserControl
{
    ...
    private GroupBoxGradientMode _BackgroundGradientMode = GroupBoxGradientMode.Vertical;
    ...
    private GroupBoxCorners _Corners = GroupBoxCorners.All;
    ...
    public GroupBoxCorners Corners
    {
        get { return _Corners; }
        set
        {
    ...
    protected override void OnPaint(PaintEventArgs e)
    {
        ...
        using (GraphicsPath path = RoundRectangle(frameRec, _CornerRadius, _Corners))
        {
            ...
            if (CaptionVisible)
            {
                ...
                using (GraphicsPath capPath = RoundRectangle(captionRec, _CornerRadius, _Corners & GroupBoxCorners.North))
                {
                ...
                if (!string.IsNullOrEmpty(Caption))
                {
                    ...
                    sf.Alignment = (System.Drawing.StringAlignment) CaptionAlignment;
